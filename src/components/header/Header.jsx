...
const Header = () => {
  ...
  return (
    <div className="bg-[#219653] h-16 inPhone">
      <div className="flex content-center">
        ...
        <div className="flex-2 w-5/12 mx-auto">
          <ul className="flex mt-4 items-around">
            <li
              onClick={() => navigate("/")}
              className="text-lg cursor-pointer font-semibold text-[#fff] hover:opacity-90 lg:ml-7 ml-6 mr-1.5"
            >
              Home
            </li>
            <li
              className="text-lg cursor-pointer font-semibold text-[#fff] hover:opacity-90 ml-6 mr-1.5"
